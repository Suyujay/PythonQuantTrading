...
# %%
# 建立決策樹模型
model = DecisionTreeClassifier(random_state=6, max_depth=2)
...
plt.title("Feature Importance of Decision Tree", fontsize=15)
plt.show()

# %%
# 使用 plot_tree 函數來繪製決策樹，顯示模型如何決策
plt.figure(figsize=(13, 13))
plot_tree(
    model,
    feature_names=feature_names,
    class_names=["Down", "Up"],  # 類別名稱：Down 代表下跌，Up 代表上漲
    filled=True,
    fontsize=16,
)
